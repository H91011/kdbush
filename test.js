...
test('creates an index', (t) => {
    const index = new KDBushOneDimension(points, undefined, undefined, 64,Float64Array, true);
    console.log(index.ids, ids, 'ids are kd-sorted');
...
test('range search', (t) => {
    const index = new KDBushOneDimension(points, undefined, undefined,10,Float64Array, true);
